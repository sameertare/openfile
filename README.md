...
- **One loaded dataset:** load your own games or an opponent's the same way — whichever account you load becomes the tree, the scouting report, and the drill deck. No separate "profiles" to switch between; loading a new source replaces what was there.
